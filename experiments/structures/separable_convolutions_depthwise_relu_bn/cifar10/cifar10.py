...
class Cifar10Model:
    ...
    def inference(self, preprocessed_input):
        ...
        with tf.variable_scope("conv_2"):
            conv_2, pruner = self.blocks.separable_conv2d(conv_1,
                                                          filter_size=5,
                                                          input_channels=16,
        ...
        with tf.variable_scope("conv_3"):
            conv_3, pruner = self.blocks.separable_conv2d(conv_2,
                                                          filter_size=5,
                                                          input_channels=32,
                                                          depthwise_multiplier=1,
                                                          output_channels=64,
        ...
        with tf.variable_scope("conv_4"):
            conv_4, pruner = self.blocks.separable_conv2d(conv_3,
                                                          filter_size=5,
                                                          input_channels=64,
                                                          depthwise_multiplier=1,
                                                          output_channels=128,
