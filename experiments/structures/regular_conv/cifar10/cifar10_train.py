...
CHECKPOINT_FOLDER = "checkpoints_normal"
CHECKPOINT_STEP = 10000
CHECKPOINT_NAME = "convolutional-cifar"
...
class Train:
    ...
    def train(self):
        with self.graph.as_default():
            ...
            train_writer = tf.summary.FileWriter("summaries/train_normal_%d" % FLAGS.run_id, self.graph)
            test_writer = tf.summary.FileWriter("summaries/test_normal_%d" % FLAGS.run_id, self.graph)
